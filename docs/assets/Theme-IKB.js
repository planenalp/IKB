...
document.addEventListener('DOMContentLoaded', function() {    
    ...
    const bgSwitcher = (function() {
        ...
        async function createLoader(targetTheme, version) {
            ...
            // 定义主地址和备选地址
            const primaryBaseUrl = `https://international.klein.blue/bg/${prefix}${randomNum}`;
            const fallbackBaseUrl = `https://international.klein.blue/IKB/bg/${prefix}${randomNum}`;
    ...
    /* 通用默认亮主题配色 */
    :root {
        /* --bgURL: url("https://international.klein.blue/bg/bgLight.webp"); */ /* 定义单个地址 */
        /* --bgURL: url("https://international.klein.blue/bg/bgLight.webp"), url("https://international.klein.blue/IKB/bg/bgLight.webp"); */ /* 定义主地址和备选地址 */
        /* avatar-blue.svg */
    ...
    [data-color-mode=dark][data-dark-theme=dark]::selection {
        /* --bgURL: url("https://international.klein.blue/bg/bgDark.webp"); */ /* 定义单个地址 */
        /* --bgURL: url("https://international.klein.blue/bg/bgDark.webp"), url("https://international.klein.blue/IKB/bg/bgDark.webp"); */ /* 定义主地址和备选地址 */
