...
document.addEventListener('DOMContentLoaded', function() {    
    ...
    const bgSwitcher = (function() {
        ...
        async function createLoader(targetTheme, version) {
            ...
            const fallbackBaseUrl = `https://planenalp.github.io/IKB/bg/${prefix}${randomNum}`;
    ...
    :root {
        ...
        /* --bgURL: url("https://international.klein.blue/bg/bgLight.webp"), url("https://planenalp.github.io/IKB/bg/bgLight.webp"); */ /* 定义主地址和备选地址 */
        /* avatar-blue.svg */
    ...
    [data-color-mode=dark][data-dark-theme=dark]::selection {
        ...
        /* --bgURL: url("https://international.klein.blue/bg/bgDark.webp"), url("https://planenalp.github.io/IKB/bg/bgDark.webp"); */ /* 定义主地址和备选地址 */
