...
# 总结
99.9% 情况下，只需用 [1. GitHub Pages upload](#1.-github-pages-upload) 模板的 MarkDown 的标准语法 `![Image](URL)`

要改居中，只能用 [6. HTML 标签 - 三行 div](#6.-html-标签---三行-div)
要改尺寸或用 base64，用 [2. Gmeek + Fancybox 引用代码](#2.-gmeek-+-fancybox-引用代码)
仅用 base64，也可用 [3. GJken 代码](#3.-gjken-代码)
实际上都没必要
...
------------------------------------------------------------------------------------
# 3. GJken 代码
来源：[Gmeek - 记录使用过程](https://gjken.github.io/post/1.html)，改成 `插件.js`
